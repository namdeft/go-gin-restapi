...
var (
	...
	favouriteService    favouriteServ.FavouriteService    = favouriteServ.NewDishService(favouriteRepository)
	favouriteController favouriteCon.FavouriteController  = favouriteCon.NewDishController(favouriteService)
)
